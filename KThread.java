...
public class KThread {
	...
	public KThread(Runnable target) {
		...
		this.target = target;
		called = 0;
		threadQueue = new LinkedList<KThread>();
		//threadQIterator = threadQueue.listIterator();
	}
...
//		}
	...
	public void join() {
		...
		// This thread is the currentThread
		else if(currentThread == this){
			return;
		}
		// we are safe to join
		else{
			// add this thread to a queue
			currentThread.status = statusBlocked;
